...
rh.mq.enableButtons = function() {
  ...
  $("#add-quote").click(function() {
    ...
    $("#insert-quote-modal input[name=id]").val("").prop("disabled", true);
  ...
  $(".delete-movie-quote").click(function() {
    entityKey = $(this).find(".id").html();
    console.log(entityKey + "!");
    $("#delete-quote-modal input[name=id]").val(entityKey);
  });
